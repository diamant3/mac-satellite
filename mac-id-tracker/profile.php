...
<head>
    ...
    <title>MAC ID Tracker - Profile</title>
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-3 text-capitalize"><?php echo $_SESSION['role']; ?></p>
                                    <a href="update-profile.php" class="btn btn-danger btn-block">Edit Profile</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <input type="text" class="form-control text-capitalize" value="<?php echo $_SESSION['firstname']; ?>" disabled>
                                        </div>
                                        <div class="col-lg-6 mb-2">
                                        <label class="text-dark font-weight-bold">Last Name</label>
                                            <input type="text" class="form-control text-capitalize" value="<?php echo $_SESSION['lastname']; ?>" disabled>
                                        </div>
                                    </div>

                                    <div class="mb-2">
                                        <label for="role" class="text-dark font-weight-bold">User Role</label>
                                        <input type="text" id="role" class="form-control text-capitalize" value="<?php echo $_SESSION['role']; ?>" disabled>
                                    </div>

                                    <div class="row">
                                    <div class="col-lg-4 mb-2">
                                            <label class="text-dark font-weight-bold">Age</label>
                                            <input type="text" class="form-control text-capitalize" value="<?php echo $_SESSION['age']; ?>" disabled>
                                        </div>
                                        <div class="col-lg-4 mb-2">
                                            <label class="text-dark font-weight-bold">Birth Date</label>
                                            <input type="text" class="form-control text-capitalize" value="<?php echo $_SESSION['birth_date']; ?>" disabled>
                                        </div>
                                        <div class="col-lg-4 mb-2">
                                            <label class="text-dark font-weight-bold">Gender</label>
                                            <input type="text" class="form-control text-capitalize" value="<?php echo $_SESSION['gender']; ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
