...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (empty($password)) {
        $passwordErr = "<span class='text-danger'>* Please input your password.</span><br />";
    }
    ...
    if (empty($usernameErr) && empty($passwordErr) && empty($roleErr)) {
        try {
            $sql = "INSERT INTO accounts (firstname, lastname, username, password, role, age, birth_date, gender) VALUES (?,?,?,?,?,?,?,?)";
            $stmt = $conn->prepare($sql);
            $stmt->execute([$firstname, $lastname, $username, $password, $role, $age, $birth_date, $gender]);
            ...
            <li class="nav-item active">
                ...
                <div id="profile" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="#">Add Employee</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Manage employees / Add Employee</h1>
                    </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        ...
                                        <div class="form-group mb-3 col-lg-12">
                                            <input type="text" id="age" class="form-control bg-light" name="age" placeholder="23">
                                        </div>

                                        <label for="birth_date" class="col-md-4 control-label text-dark mb-1">Birth Date</label>
                                        <div class="form-group mb-3 col-lg-12">
                                            <input type="text" id="birth_date" class="form-control bg-light" name="birth_date" placeholder="May 1 1995">
                                        </div>

                                        <label for="gender" class="col-md-4 control-label text-dark mb-1">Gender</label>
                                        <div class="form-group mb-3 col-lg-12">
                                            <input type="text" id="gender" class="form-control bg-light" name="gender" placeholder="Male">
                                        </div>

                                        <?php echo $usernameErr; ?>
                                        <label for="username" class="col-md-4 control-label text-dark mb-1">Username <small class="text-sm text-danger">*</small></label>
                                        <div class="form-group mb-3 col-lg-12">
                                            <input type="text" id="username" class="form-control bg-light" name="username" placeholder="Username">
                                        </div>

                                        <?php echo $passwordErr; ?>
                                        <label for="password" class="col-md-4 control-label text-dark mb-1">Password <small class="text-sm text-danger">*</small></label>
                                        <div class="form-group mb-3 col-lg-12">
                                            <input type="text" id="password" class="form-control bg-light" name="password" placeholder="Password">
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <select name="role" class="btn btn-primary btn-block shadow mb-1">
                                                    <option class="bg-white text-dark" value="">--- Choose a role ---</option>
                                                    <option class="bg-white text-dark" value="employee">Employee</option>
                                                    <option class="bg-white text-dark" value="administrator">Administrator</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-6">
