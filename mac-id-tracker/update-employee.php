            ...
            <li class="nav-item active">
                ...
                <div id="profile" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="#">Update Employee</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 text-gray-800">Manage employees / Update Employee</h1>
                    </div>
                                ...
                                <div id="table_result" class="card-body">
                                    ...
                                    if ($count > 0) {
                                        ...
                                        foreach ($fetch as $row) {
                                            ...
                                            echo "<td class='text-dark'><a class='btn btn-warning' href='update-employee-form.php?id={$row['id']}'>Update</button></td>";
                                            echo "</tr>";
                                        }
