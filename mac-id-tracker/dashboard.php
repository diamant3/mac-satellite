...
try {
    $blue_arr = $conn->query("SELECT * FROM blue_id")->fetchAll();
    $yellow_arr = $conn->query("SELECT * FROM yellow_id")->fetchAll();
    $white_arr = $conn->query("SELECT * FROM white_id")->fetchAll();

    $blue_total = count($blue_arr);
    $yellow_total = count($yellow_arr);
    $white_total = count($white_arr);

    $id_total = $blue_total + $yellow_total + $white_total;
...
<head>
    ...
    <title>MAC ID Tracker - Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#card"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-700 small text-capitalize">Welcome, <?php echo $_SESSION["firstname"] . " " . $_SESSION["lastname"]; ?>!</span>
                                <img class="img-profile rounded-circle"
                                    src="uploads/<?php echo $_SESSION['profile_image'] ?>">
                            </a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Blue Card</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $blue_total; ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                yellow card</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $yellow_total; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-id-card fa-2x text-gray-300"></i>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-dark shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">White card
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $white_total; ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                total</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $id_total; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-id-card fa-2x text-gray-300"></i>
                                        </div>
